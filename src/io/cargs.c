 ...
 * @file cargs.c
 * @author Leonard Iklé
 * @brief This file contains the implementation of the cargs library
 * @details originally from https://github.com/likle/cargs/blob/master/src/cargs.c
 */

#include <assert.h>
#include "include/cargs.h"  // modified this line for the manganese codebase
#include <stdbool.h>
#include <stdio.h>
#include <string.h>
