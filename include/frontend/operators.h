...
struct Operator {
    ...
    static Operator prefix(Precedence rightBindingPower_ = Precedence::Default) {
        return Operator{
            .leftBindingPower = Precedence::Unary,
            .rightBindingPower = rightBindingPower_};
    }

    static Operator postfix(Precedence leftBindingPower_ = Precedence::Default) {
        return Operator{
            .leftBindingPower = leftBindingPower_,
            .rightBindingPower = Precedence::Postfix};
    }

    static Operator binary(Precedence bindingPower) {
        return Operator{
            .leftBindingPower = bindingPower,
            .rightBindingPower = bindingPower};
    }
