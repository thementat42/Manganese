...
#define __ENABLE_CONVERSION_WARNING _Pragma("clang diagnostic pop")

#elif defined(__GNUC__)
#define __DISABLE_CONVERSION_WARNING _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wconversion\"")

#define __ENABLE_CONVERSION_WARNING _Pragma("GCC diagnostic pop")

#elif defined(_MSC_VER)
#define __DISABLE_CONVERSION_WARNING          \
    __pragma(warning(push)) __pragma(warning( \
        disable : 4244))  // 4244 is the warning code for conversion from 'type1' to 'type2', possible loss of data

#define __ENABLE_CONVERSION_WARNING __pragma(warning(pop))
...
#define __DISABLE_SIGN_COMPARE_WARNING \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wsign-compare\"")

#define __ENABLE_SIGN_COMPARE_WARNING _Pragma("clang diagnostic pop")

#elif defined(__GNUC__)
#define __DISABLE_SIGN_COMPARE_WARNING \
    _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wsign-compare\"")

#define __ENABLE_SIGN_COMPARE_WARNING _Pragma("GCC diagnostic pop")

#elif defined(_MSC_VER)
#define __DISABLE_SIGN_COMPARE_WARNING \
    __pragma(warning(push)) __pragma(warning(disable : 4018))  // 4018: signed/unsigned mismatch

#define __ENABLE_SIGN_COMPARE_WARNING __pragma(warning(pop))
...
#if defined(__clang__)
#define __DISABLE_FORMAT_WARNING _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wformat\"")

#define __ENABLE_FORMAT_WARNING _Pragma("clang diagnostic pop")

#elif defined(__GNUC__)
#define __DISABLE_FORMAT_WARNING _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wformat\"")

#define __ENABLE_FORMAT_WARNING _Pragma("GCC diagnostic pop")

#elif defined(_MSC_VER)
#define __DISABLE_FORMAT_WARNING \
    __pragma(warning(push)) __pragma(warning(disable : 4477))  // 4477: format string '%x' requires an argument of type
                                                               // 'y', but variadic argument z has type 'w'

#define __ENABLE_FORMAT_WARNING __pragma(warning(pop))
...
#define DISABLE_CONVERSION_WARNING \
    __DISABLE_CONVERSION_WARNING  // Supress a warning about a conversion causing data loss
...
#define DISABLE_SIGN_COMPARE_WARNING \
    __DISABLE_SIGN_COMPARE_WARNING  // Suppress warnings about signed/unsigned comparison
