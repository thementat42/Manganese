...
class Reader {
   public:
    ...
    [[nodiscard]] virtual std::size_t getPosition() const noexcept = 0;
    [[nodiscard]] virtual std::size_t getLine() const noexcept = 0;
    [[nodiscard]] virtual std::size_t getColumn() const noexcept = 0;
