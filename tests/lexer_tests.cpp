...
static bool testOperators() {
    ...
    return checkToken(tokens[0], TokenType::Plus, "+") && checkToken(tokens[1], TokenType::Minus, "-")
        ...
        && checkToken(tokens[25], TokenType::Ellipsis, "...") && checkToken(tokens[26], TokenType::BitXorAssign, "^=")
        && checkToken(tokens[27], TokenType::MemberAccess, ".") && checkToken(tokens[28], TokenType::Colon, ":")
        && checkToken(tokens[29], TokenType::ScopeResolution, "::")
