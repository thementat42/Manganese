...
| 4          | `++x` <br> `--x` <br> `+x` <br> `-x` <br> `!` <br> `~` <br> `as` <br> `*` <br> `&` | Prefix Increment <br> Prefix Decrement <br> Unary Positive <br> Unary Negative <br> Logical NOT <br> Bitwise NOT <br> Type Cast <br> Dereference <br> Address-of | Right |
